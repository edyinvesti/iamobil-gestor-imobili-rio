            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-zinc-900 border border-white/10 rounded-3xl p-6 space-y-4">
                    ...
                    <div className="flex flex-wrap gap-3">
                        {images.map((img, idx) => (
                            <div key={idx} className="relative w-28 h-20 rounded-2xl overflow-hidden border border-white/10 group">
                        ...
                        <label className="w-28 h-20 rounded-2xl border border-dashed border-white/10 flex flex-col items-center justify-center gap-1.5 cursor-pointer hover:bg-white/5 hover:border-orange-500/30 transition-all text-gray-700 hover:text-orange-500 bg-black/20">
                            <Camera size={18} />
                ...
                <div className="bg-zinc-900 border border-white/10 rounded-3xl p-6 space-y-5">
                    <p className="text-[10px] font-black uppercase text-gray-500 tracking-widest">Dados do Imóvel</p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <select
                                className="w-full bg-black/40 border border-white/5 rounded-2xl px-4 py-4 text-white text-sm font-bold outline-none appearance-none cursor-pointer"
                                value={formData.type}
                        ...
                        <div className="space-y-2">
                            ...
                            <select
                                className="w-full bg-black/40 border border-white/5 rounded-2xl px-4 py-4 text-orange-500 text-sm font-bold outline-none appearance-none cursor-pointer"
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <DollarSign size={18} className="absolute left-5 top-1/2 -translate-y-1/2 text-orange-500" />
                            <input
                                required
                                type="number"
                                className="w-full bg-black/40 border border-white/5 rounded-2xl pl-14 pr-5 py-4 text-white text-xl font-black outline-none focus:ring-1 focus:ring-orange-500 transition-all"
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <input
                                type="number"
                                className="w-full bg-black/40 border border-white/5 rounded-2xl px-5 py-4 text-white text-lg font-black outline-none focus:ring-1 focus:ring-orange-500 transition-all"
                                value={formData.size || ''}
                ...
                <div className="bg-zinc-900 border border-white/10 rounded-3xl p-6 space-y-3">
                    <label className="text-[10px] font-black uppercase text-gray-500 tracking-widest">Descrição do Imóvel</label>
                    <textarea
                        className="w-full bg-black/40 border border-white/5 rounded-2xl p-5 text-white text-sm font-bold outline-none focus:ring-1 focus:ring-orange-500 transition-all min-h-[120px] placeholder:text-gray-800 resize-none"
                ...
                <button
                    type="submit"
                    className="w-full h-16 bg-orange-500 hover:bg-orange-600 rounded-[20px] font-black text-xs uppercase tracking-[0.3em] text-white shadow-xl shadow-orange-500/20 transition-all active:scale-[0.99] flex items-center justify-center gap-3 group"
                >
